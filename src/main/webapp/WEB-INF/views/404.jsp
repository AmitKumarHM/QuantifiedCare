		...
		<table width="1002" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="middle" align="center" valign="top"><br />
					...
					<center>
						<form action="<%=request.getContextPath() %>/advisors/client/create" method="post" enctype="multipart/form-data">
					...
					<center>
						<form action="<%=request.getContextPath() %>/advisors/client/edit" method="post" enctype="multipart/form-data">
							<table width="600" border="0" align="center" cellpadding="0"
								cellspacing="0">
								<tr>
									<td height="3" align="center" bgcolor="#ce3e3e"></td>
