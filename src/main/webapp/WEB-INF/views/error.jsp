						...
						<form name="input" action="./decrypt" method="post">
							<table width="600" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td height="34" align="center" bgcolor="#bfcfdc"><div
											style="font-family: tahoma; font-size: 16px; color: #063557; font-weight: bold; text-align: center; padding: 10px">Change Password Status</div>
									</td>
								</tr>
							</table>
							<div style="border: 1px solid #cccccc; background: #FFFFFF; width: 600px; margin: 0px auto; font-size: 12px; color: #333333; font-family: tahoma">
								...
								<table width="600" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td align="center" valign="top" style="padding: 5px 10px">${msg}</td>
									</tr>
									<tr>
